        ...
        <div className="contact-wrap">
            ...
            <div className="contact-container">
                ...
                <div className="contact-sect">
                    <ContactItem icon={contact} text1={'+977 9865711881'} text2={'+977 9881316827'} title={'Phone'}/>
                    <ContactItem icon={emailme} text1={'bidursapkota00@gmail.com'} text2={'bidursapkota000@gmail.com'} title={'Email'}/>
